...
describe('Validate TS configs', () => {
  it('Validate blackworld-eslint-config/typescript', async () => {
  ...
  it('Validate blackworld-eslint-config/typescript/vue', async () => {
  ...
  it('Validate blackworld-eslint-config/essential/typescript', async () => {
  ...
  it('Validate blackworld-eslint-config/essential/typescript/react', async () => {
  ...
  it('Validate blackworld-eslint-config/essential/typescript/vue', async () => {
  ...
  it('Validate blackworld-eslint-config/typescript/node', async () => {
