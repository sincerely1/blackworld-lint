...
describe('Validate JS configs', () => {
  it('Validate blackworld-eslint-config', async () => {
  ...
  it('Validate blackworld-eslint-config/es5', async () => {
  ...
  it('Validate blackworld-eslint-config/vue', async () => {
  ...
  it('Validate blackworld-eslint-config/essential', async () => {
  ...
  it('Validate blackworld-eslint-config/essential/es5', async () => {
  ...
  it('Validate blackworld-eslint-config/essential/react', async () => {
  ...
  it('Validate blackworld-eslint-config/essential/vue', async () => {
  ...
  it('Validate blackworld-eslint-config/node', async () => {
